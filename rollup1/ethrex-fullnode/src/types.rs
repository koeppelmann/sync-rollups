...
pub mod fn_selectors {
    ...
    pub fn execute_incoming_cross_chain_call() -> [u8; 4] {
        selector("executeIncomingCrossChainCall(address,uint256,bytes,address,uint256,uint256[])")
    }
    ...
    pub fn load_execution_table() -> [u8; 4] {
        selector("loadExecutionTable(((uint256,bytes32,bytes32,int256)[],bytes32,(uint8,uint256,address,uint256,bytes,bool,address,uint256,uint256[]))[])")
    }
